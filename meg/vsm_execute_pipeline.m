function vsm_execute_pipeline(pipelinename, varargin)

% VSM_EXECUTE_PIPELINE serves the purpose to make a script executable by qsub.
...
%
% qsubfeval('erfosc_superscript', {'someothervariable' value}, 'memreq', memreq, 'timreq', timreq);
% 
