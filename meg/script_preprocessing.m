...
inpcfg  = {'audiofile', 'all', ...
          'dospeechenvelope', 1, ...
          'dofeature', 1, ...
          'feature', {'entropy', 'perplexity', 'log10wf', 'duration'}, ...
          'bpfreq', [0.5 40], ...
          'lpfreq', [], ...
          'hpfreq', [], ...
          'word_quantify', 'all', ...
...
%save(fullfile(d.preproc, [subject '_meg.mat']), 'data');
%save(fullfile(d.preproc, [subject '_aud.mat']), 'audio');
save(fullfile(d.preproc, [subject '_lng-box.mat']), 'featuredata');
